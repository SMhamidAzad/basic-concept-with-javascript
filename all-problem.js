...
//------BASIC JAVASCRIPT PROBLEM SOLBING----------------------------
...
const multifly = number1*number2;
...
const bikePrice = 20000;
const myMoney = 12000;
if(myMoney>bikePrice){
    console.log('I will buy this bike');
}
else{
    console.log('Happy with buying a bicycle');
}
*/
...
const array = [12, 32, 89, 10, 29, 50, 21];
console.log(array.length);
array[3]=22;
const sumTwoNumber = array[0]+array[1];
array.pop();
 */
...
const array= [30, 90, 70, 81, 91, 20, 98, 86];
...
function multificationOf3Numbers(number1,number2,number3){
    const resultOfMultifly = number1*number2*number3;
    return resultOfMultifly;
}
const result = multificationOf3Numbers(10,3,10);
console.log('Result of Multification of three numbers:',result); 
*/
...
const Meter = centimeterToMeter(400);
...
function paperRequirements(firstBookCopy, secondBookCopy, thirdBookCopy){
    // need per page pages
    const pageNeedFirstPerBook = 100;
    const pageNeedSecondPerBook = 200;
    const pageNeedThirdPerBook = 300;

    // total page for per book
    const totalFirstBookPageNeed = firstBookCopy*pageNeedFirstPerBook;
    const totalSecondBookPageNeed = secondBookCopy*pageNeedSecondPerBook;
    const totalThirdBookPageNeed = thirdBookCopy*pageNeedThirdPerBook;

    // total page
    const totalPageNeed =totalFirstBookPageNeed+totalSecondBookPageNeed+totalThirdBookPageNeed;
    return totalPageNeed;
}

const totalPage = paperRequirements(2,3,5);
console.log('Total page needed',totalPage); 
*/
...
function bestFriend(bestFriendNameList){
   let bigName = '';
   for(let i=0;i<bestFriendNameList.length;i++){
       let nameletterCount = bestFriendNameList[i].length;
       let bigNameLetterCount = bigName.length;
       if(nameletterCount>bigNameLetterCount){
           bigName = bestFriendNameList[i];
       }
   }
   return bigName;
}
let bestFriendNameList = ['Hanif','Haider','Obaydullah','Rafi', 'Shafayet'];
let friendWithLargeName = bestFriend(bestFriendNameList);
console.log('Large name is ',friendWithLargeName); 
*/

/*৫. এইটা একটু ট্রিকি হতে পারে। একটা array এর মধ্যে অনেকগুলা সংখ্যা থাকবে। তোমার কাজ হচ্ছে সংখ্যা গুলা একটার পর একটা করে চেক করা। এবং সংখ্যা গুলা যদি পজিটিভ সংখ্যা হয়। অর্থাৎ শূন্য বা শূন্যের চাইতে বড় হয় তাহলে সেগুলাকে কোন একটা array এর মধ্যে রাখবে। আর যদি নেগেটিভ সংখ্যা হয়। তাহলে লুপটা স্টপ করে দিবে। এবং লুপ বন্ধ করার আগ পর্যন্ত যতগুলা পজিটিভ সংখ্যা পাওয়া গেছে। সেগুলা রিটার্ন করে দিবে। 

function positiveBeforeNegative(allnumber){
    const positveValue = [];
    for(let i=0;i<allnumber.length; i++){
        if(allnumber[i]>=0){
            positveValue.push(allnumber[i]);
        }
        else{
            break;
        }
...
const array = [10, 0, 3, 8, 9, -1, 34, 9, -2, 9];
const positiveNumber = positiveBeforeNegative(array);
